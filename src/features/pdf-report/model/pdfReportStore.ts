...
// собрать только тот экран, что сейчас отрисован (пока — только "Обзор",
// "Автоколонна"/"Аналитика" ещё заглушки). Экран при монтировании
// регистрирует свой обработчик здесь, стор не знает о конкретных экранах.
